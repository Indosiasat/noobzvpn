...
let Pswd = "trojan";
const proxyIPs = ["103.168.146.169":20132]; //ts.hpc.tw edgetunnel.anycast.eu.org bestproxy.onecf.eu.org cdn-all.xn--b6gac.eu.org cdn.xn--b6gac.eu.org proxy.xxxxxxxx.tk
let cn_hostnames = [''];
			...
			<table class="table">
				...
				<tbody>
					<tr>
						...
						<td><button class="btn btn-primary" onclick="copyToClipboard('${ptrojanwstls}')">Klik untuk menyalin tautan</button></td>
					</tr>
				</tbody>
			</table>
            <h5>Parameter klien adalah sebagai berikut：</h5>
